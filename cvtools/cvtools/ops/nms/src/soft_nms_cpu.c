...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cvtools.ops.nms.soft_nms_cpu",
        "sources": [
            "cvtools\\ops\\nms\\src/soft_nms_cpu.pyx"
        ]
    },
    "module_name": "cvtools.ops.nms.soft_nms_cpu"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cvtools__ops__nms__soft_nms_cpu
#define __PYX_HAVE_API__cvtools__ops__nms__soft_nms_cpu
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'cvtools.ops.nms.soft_nms_cpu' */
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_max(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_min(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_float = { "float", NULL, sizeof(float), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "cvtools.ops.nms.soft_nms_cpu"
extern int __pyx_module_is_main_cvtools__ops__nms__soft_nms_cpu;
int __pyx_module_is_main_cvtools__ops__nms__soft_nms_cpu = 0;

/* Implementation of 'cvtools.ops.nms.soft_nms_cpu' */
...
static const char __pyx_k_cvtools_ops_nms_soft_nms_cpu[] = "cvtools.ops.nms.soft_nms_cpu";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_cvtools_ops_nms_src_soft_nms_cpu[] = "cvtools\\ops\\nms\\src\\soft_nms_cpu.pyx";
...
static PyObject *__pyx_n_s_cvtools_ops_nms_soft_nms_cpu;
static PyObject *__pyx_kp_s_cvtools_ops_nms_src_soft_nms_cpu;
...
static PyObject *__pyx_pf_7cvtools_3ops_3nms_12soft_nms_cpu_soft_nms_cpu(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes_in, float __pyx_v_iou_thr, unsigned int __pyx_v_method, float __pyx_v_sigma, float __pyx_v_min_score); /* proto */
...
/* "cvtools/ops/nms/src/soft_nms_cpu.pyx":15
 * 
 * 
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_max(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("max", 0);

  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":16
 * 
 * cdef inline np.float32_t max(np.float32_t a, np.float32_t b):
 *     return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "cvtools/ops/nms/src/soft_nms_cpu.pyx":18
 *     return a if a >= b else b
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):             # <<<<<<<<<<<<<<
 *     return a if a <= b else b
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_min(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("min", 0);

  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":19
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):
 *     return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "cvtools/ops/nms/src/soft_nms_cpu.pyx":22
 * 
 * 
 * def soft_nms_cpu(             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_7cvtools_3ops_3nms_12soft_nms_cpu_1soft_nms_cpu(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_7cvtools_3ops_3nms_12soft_nms_cpu_1soft_nms_cpu = {"soft_nms_cpu", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7cvtools_3ops_3nms_12soft_nms_cpu_1soft_nms_cpu, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7cvtools_3ops_3nms_12soft_nms_cpu_1soft_nms_cpu(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cvtools.ops.nms.soft_nms_cpu.soft_nms_cpu", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_7cvtools_3ops_3nms_12soft_nms_cpu_soft_nms_cpu(__pyx_self, __pyx_v_boxes_in, __pyx_v_iou_thr, __pyx_v_method, __pyx_v_sigma, __pyx_v_min_score);
...
static PyObject *__pyx_pf_7cvtools_3ops_3nms_12soft_nms_cpu_soft_nms_cpu(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes_in, float __pyx_v_iou_thr, unsigned int __pyx_v_method, float __pyx_v_sigma, float __pyx_v_min_score) {
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":29
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":30
 * ):
 *     boxes = boxes_in.copy()
 *     cdef int N = boxes.shape[0]             # <<<<<<<<<<<<<<
 *     cdef float iw, ih, box_area
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":33
 *     cdef float iw, ih, box_area
 *     cdef float ua
 *     cdef int pos = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":34
 *     cdef float ua
 *     cdef int pos = 0
 *     cdef float maxscore = 0             # <<<<<<<<<<<<<<
 *     cdef int maxpos = 0
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":35
 *     cdef int pos = 0
 *     cdef float maxscore = 0
 *     cdef int maxpos = 0             # <<<<<<<<<<<<<<
 *     cdef float x1, x2, y1, y2, tx1, tx2, ty1, ty2, ts, area, weight, ov
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":37
 *     cdef int maxpos = 0
 *     cdef float x1, x2, y1, y2, tx1, tx2, ty1, ty2, ts, area, weight, ov
 *     inds = np.arange(N)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":39
 *     inds = np.arange(N)
 * 
 *     for i in range(N):             # <<<<<<<<<<<<<<
 *         maxscore = boxes[i, 4]
 ...
 */
  ...
  for (;;) {
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":40
 * 
 *     for i in range(N):
 *         maxscore = boxes[i, 4]             # <<<<<<<<<<<<<<
 *         maxpos = i
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":41
 *     for i in range(N):
 *         maxscore = boxes[i, 4]
 *         maxpos = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":43
 *         maxpos = i
 * 
 *         tx1 = boxes[i, 0]             # <<<<<<<<<<<<<<
 *         ty1 = boxes[i, 1]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":44
 * 
 *         tx1 = boxes[i, 0]
 *         ty1 = boxes[i, 1]             # <<<<<<<<<<<<<<
 *         tx2 = boxes[i, 2]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":45
 *         tx1 = boxes[i, 0]
 *         ty1 = boxes[i, 1]
 *         tx2 = boxes[i, 2]             # <<<<<<<<<<<<<<
 *         ty2 = boxes[i, 3]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":46
 *         ty1 = boxes[i, 1]
 *         tx2 = boxes[i, 2]
 *         ty2 = boxes[i, 3]             # <<<<<<<<<<<<<<
 *         ts = boxes[i, 4]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":47
 *         tx2 = boxes[i, 2]
 *         ty2 = boxes[i, 3]
 *         ts = boxes[i, 4]             # <<<<<<<<<<<<<<
 *         ti = inds[i]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":48
 *         ty2 = boxes[i, 3]
 *         ts = boxes[i, 4]
 *         ti = inds[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":50
 *         ti = inds[i]
 * 
 *         pos = i + 1             # <<<<<<<<<<<<<<
 *         # get max box
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":52
 *         pos = i + 1
 *         # get max box
 *         while pos < N:             # <<<<<<<<<<<<<<
 ...
 */
    while (1) {
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":53
 *         # get max box
 *         while pos < N:
 *             if maxscore < boxes[pos, 4]:             # <<<<<<<<<<<<<<
 *                 maxscore = boxes[pos, 4]
 ...
 */
      ...
      if (__pyx_t_9) {
        ...
        /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":54
 *         while pos < N:
 *             if maxscore < boxes[pos, 4]:
 *                 maxscore = boxes[pos, 4]             # <<<<<<<<<<<<<<
 *                 maxpos = pos
 ...
 */
        ...
        /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":55
 *             if maxscore < boxes[pos, 4]:
 *                 maxscore = boxes[pos, 4]
 *                 maxpos = pos             # <<<<<<<<<<<<<<
 *             pos = pos + 1
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":56
 *                 maxscore = boxes[pos, 4]
 *                 maxpos = pos
 *             pos = pos + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":59
 * 
 *         # add max box as a detection
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":60
 *         # add max box as a detection
 *         boxes[i, 0] = boxes[maxpos, 0]
 *         boxes[i, 1] = boxes[maxpos, 1]             # <<<<<<<<<<<<<<
 *         boxes[i, 2] = boxes[maxpos, 2]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":61
 *         boxes[i, 0] = boxes[maxpos, 0]
 *         boxes[i, 1] = boxes[maxpos, 1]
 *         boxes[i, 2] = boxes[maxpos, 2]             # <<<<<<<<<<<<<<
 *         boxes[i, 3] = boxes[maxpos, 3]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":62
 *         boxes[i, 1] = boxes[maxpos, 1]
 *         boxes[i, 2] = boxes[maxpos, 2]
 *         boxes[i, 3] = boxes[maxpos, 3]             # <<<<<<<<<<<<<<
 *         boxes[i, 4] = boxes[maxpos, 4]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":63
 *         boxes[i, 2] = boxes[maxpos, 2]
 *         boxes[i, 3] = boxes[maxpos, 3]
 *         boxes[i, 4] = boxes[maxpos, 4]             # <<<<<<<<<<<<<<
 *         inds[i] = inds[maxpos]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":64
 *         boxes[i, 3] = boxes[maxpos, 3]
 *         boxes[i, 4] = boxes[maxpos, 4]
 *         inds[i] = inds[maxpos]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":67
 * 
 *         # swap ith box with position of max box
 *         boxes[maxpos, 0] = tx1             # <<<<<<<<<<<<<<
 *         boxes[maxpos, 1] = ty1
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":68
 *         # swap ith box with position of max box
 *         boxes[maxpos, 0] = tx1
 *         boxes[maxpos, 1] = ty1             # <<<<<<<<<<<<<<
 *         boxes[maxpos, 2] = tx2
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":69
 *         boxes[maxpos, 0] = tx1
 *         boxes[maxpos, 1] = ty1
 *         boxes[maxpos, 2] = tx2             # <<<<<<<<<<<<<<
 *         boxes[maxpos, 3] = ty2
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":70
 *         boxes[maxpos, 1] = ty1
 *         boxes[maxpos, 2] = tx2
 *         boxes[maxpos, 3] = ty2             # <<<<<<<<<<<<<<
 *         boxes[maxpos, 4] = ts
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":71
 *         boxes[maxpos, 2] = tx2
 *         boxes[maxpos, 3] = ty2
 *         boxes[maxpos, 4] = ts             # <<<<<<<<<<<<<<
 *         inds[maxpos] = ti
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":72
 *         boxes[maxpos, 3] = ty2
 *         boxes[maxpos, 4] = ts
 *         inds[maxpos] = ti             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":74
 *         inds[maxpos] = ti
 * 
 *         tx1 = boxes[i, 0]             # <<<<<<<<<<<<<<
 *         ty1 = boxes[i, 1]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":75
 * 
 *         tx1 = boxes[i, 0]
 *         ty1 = boxes[i, 1]             # <<<<<<<<<<<<<<
 *         tx2 = boxes[i, 2]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":76
 *         tx1 = boxes[i, 0]
 *         ty1 = boxes[i, 1]
 *         tx2 = boxes[i, 2]             # <<<<<<<<<<<<<<
 *         ty2 = boxes[i, 3]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":77
 *         ty1 = boxes[i, 1]
 *         tx2 = boxes[i, 2]
 *         ty2 = boxes[i, 3]             # <<<<<<<<<<<<<<
 *         ts = boxes[i, 4]
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":78
 *         tx2 = boxes[i, 2]
 *         ty2 = boxes[i, 3]
 *         ts = boxes[i, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":80
 *         ts = boxes[i, 4]
 * 
 *         pos = i + 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":83
 *         # NMS iterations, note that N changes if detection boxes fall below
 *         # threshold
 *         while pos < N:             # <<<<<<<<<<<<<<
 *             x1 = boxes[pos, 0]
 ...
 */
    while (1) {
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":84
 *         # threshold
 *         while pos < N:
 *             x1 = boxes[pos, 0]             # <<<<<<<<<<<<<<
 *             y1 = boxes[pos, 1]
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":85
 *         while pos < N:
 *             x1 = boxes[pos, 0]
 *             y1 = boxes[pos, 1]             # <<<<<<<<<<<<<<
 *             x2 = boxes[pos, 2]
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":86
 *             x1 = boxes[pos, 0]
 *             y1 = boxes[pos, 1]
 *             x2 = boxes[pos, 2]             # <<<<<<<<<<<<<<
 *             y2 = boxes[pos, 3]
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":87
 *             y1 = boxes[pos, 1]
 *             x2 = boxes[pos, 2]
 *             y2 = boxes[pos, 3]             # <<<<<<<<<<<<<<
 *             s = boxes[pos, 4]
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":88
 *             x2 = boxes[pos, 2]
 *             y2 = boxes[pos, 3]
 *             s = boxes[pos, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":90
 *             s = boxes[pos, 4]
 * 
 *             area = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":91
 * 
 *             area = (x2 - x1 + 1) * (y2 - y1 + 1)
 *             iw = (min(tx2, x2) - max(tx1, x1) + 1)             # <<<<<<<<<<<<<<
 *             if iw > 0:
 ...
 */
      __pyx_v_iw = ((__pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_min(__pyx_v_tx2, __pyx_v_x2) - __pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_max(__pyx_v_tx1, __pyx_v_x1)) + 1.0);

      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":92
 *             area = (x2 - x1 + 1) * (y2 - y1 + 1)
 *             iw = (min(tx2, x2) - max(tx1, x1) + 1)
 *             if iw > 0:             # <<<<<<<<<<<<<<
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)
 ...
 */
      ...
      if (__pyx_t_9) {
        ...
        /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":93
 *             iw = (min(tx2, x2) - max(tx1, x1) + 1)
 *             if iw > 0:
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)             # <<<<<<<<<<<<<<
 *                 if ih > 0:
 ...
 */
        __pyx_v_ih = ((__pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_min(__pyx_v_ty2, __pyx_v_y2) - __pyx_f_7cvtools_3ops_3nms_12soft_nms_cpu_max(__pyx_v_ty1, __pyx_v_y1)) + 1.0);

        /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":94
 *             if iw > 0:
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)
 *                 if ih > 0:             # <<<<<<<<<<<<<<
 *                     ua = float((tx2 - tx1 + 1) * (ty2 - ty1 + 1) + area - iw * ih)
 ...
 */
        ...
        if (__pyx_t_9) {
          ...
          /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":95
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)
 *                 if ih > 0:
 *                     ua = float((tx2 - tx1 + 1) * (ty2 - ty1 + 1) + area - iw * ih)             # <<<<<<<<<<<<<<
 *                     ov = iw * ih / ua  # iou between max box and detection box
 ...
 */
          ...
          /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":96
 *                 if ih > 0:
 *                     ua = float((tx2 - tx1 + 1) * (ty2 - ty1 + 1) + area - iw * ih)
 *                     ov = iw * ih / ua  # iou between max box and detection box             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":98
 *                     ov = iw * ih / ua  # iou between max box and detection box
 * 
 *                     if method == 1:  # linear             # <<<<<<<<<<<<<<
 *                         if ov > iou_thr:
 ...
 */
          switch (__pyx_v_method) {
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":99
 * 
 *                     if method == 1:  # linear
 *                         if ov > iou_thr:             # <<<<<<<<<<<<<<
 *                             weight = 1 - ov
 ...
 */
            ...
            if (__pyx_t_9) {
              ...
              /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":100
 *                     if method == 1:  # linear
 *                         if ov > iou_thr:
 *                             weight = 1 - ov             # <<<<<<<<<<<<<<
 *                         else:
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":102
 *                             weight = 1 - ov
 *                         else:
 *                             weight = 1             # <<<<<<<<<<<<<<
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":104
 *                             weight = 1
 *                     elif method == 2:  # gaussian
 *                         weight = np.exp(-(ov * ov) / sigma)             # <<<<<<<<<<<<<<
 *                     else:  # original NMS
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":103
 *                         else:
 *                             weight = 1
 *                     elif method == 2:  # gaussian             # <<<<<<<<<<<<<<
 *                         weight = np.exp(-(ov * ov) / sigma)
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":106
 *                         weight = np.exp(-(ov * ov) / sigma)
 *                     else:  # original NMS
 *                         if ov > iou_thr:             # <<<<<<<<<<<<<<
 *                             weight = 0
 ...
 */
            ...
            if (__pyx_t_9) {
              ...
              /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":107
 *                     else:  # original NMS
 *                         if ov > iou_thr:
 *                             weight = 0             # <<<<<<<<<<<<<<
 *                         else:
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":109
 *                             weight = 0
 *                         else:
 *                             weight = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":111
 *                             weight = 1
 * 
 *                     boxes[pos, 4] = weight * boxes[pos, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":115
 *                     # if box score falls below threshold, discard the box by
 ...
 */
          ...
          if (__pyx_t_9) {
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":116
 *                     # swapping with last box update N
 *                     if boxes[pos, 4] < min_score:
 *                         boxes[pos, 0] = boxes[N-1, 0]             # <<<<<<<<<<<<<<
 *                         boxes[pos, 1] = boxes[N-1, 1]
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":117
 *                     if boxes[pos, 4] < min_score:
 *                         boxes[pos, 0] = boxes[N-1, 0]
 *                         boxes[pos, 1] = boxes[N-1, 1]             # <<<<<<<<<<<<<<
 *                         boxes[pos, 2] = boxes[N-1, 2]
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":118
 *                         boxes[pos, 0] = boxes[N-1, 0]
 *                         boxes[pos, 1] = boxes[N-1, 1]
 *                         boxes[pos, 2] = boxes[N-1, 2]             # <<<<<<<<<<<<<<
 *                         boxes[pos, 3] = boxes[N-1, 3]
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":119
 *                         boxes[pos, 1] = boxes[N-1, 1]
 *                         boxes[pos, 2] = boxes[N-1, 2]
 *                         boxes[pos, 3] = boxes[N-1, 3]             # <<<<<<<<<<<<<<
 *                         boxes[pos, 4] = boxes[N-1, 4]
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":120
 *                         boxes[pos, 2] = boxes[N-1, 2]
 *                         boxes[pos, 3] = boxes[N-1, 3]
 *                         boxes[pos, 4] = boxes[N-1, 4]             # <<<<<<<<<<<<<<
 *                         inds[pos] = inds[N - 1]
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":121
 *                         boxes[pos, 3] = boxes[N-1, 3]
 *                         boxes[pos, 4] = boxes[N-1, 4]
 *                         inds[pos] = inds[N - 1]             # <<<<<<<<<<<<<<
 *                         N = N - 1
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":122
 *                         boxes[pos, 4] = boxes[N-1, 4]
 *                         inds[pos] = inds[N - 1]
 *                         N = N - 1             # <<<<<<<<<<<<<<
 *                         pos = pos - 1
 ...
 */
            ...
            /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":123
 *                         inds[pos] = inds[N - 1]
 *                         N = N - 1
 *                         pos = pos - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":125
 *                         pos = pos - 1
 * 
 *             pos = pos + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":127
 *             pos = pos + 1
 * 
 *     return boxes[:N], inds[:N]             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cvtools_ops_nms_soft_nms_cpu, __pyx_k_cvtools_ops_nms_soft_nms_cpu, sizeof(__pyx_k_cvtools_ops_nms_soft_nms_cpu), 0, 0, 1, 1},
  {&__pyx_kp_s_cvtools_ops_nms_src_soft_nms_cpu, __pyx_k_cvtools_ops_nms_src_soft_nms_cpu, sizeof(__pyx_k_cvtools_ops_nms_src_soft_nms_cpu), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(5, 0, 30, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cvtools_ops_nms_src_soft_nms_cpu, __pyx_n_s_soft_nms_cpu, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cvtools__ops__nms__soft_nms_cpu) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cvtools.ops.nms.soft_nms_cpu")) {
      if (unlikely(PyDict_SetItemString(modules, "cvtools.ops.nms.soft_nms_cpu", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":11
 ...
 *     float iou_thr,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7cvtools_3ops_3nms_12soft_nms_cpu_1soft_nms_cpu, NULL, __pyx_n_s_cvtools_ops_nms_soft_nms_cpu); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_soft_nms_cpu, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cvtools/ops/nms/src/soft_nms_cpu.pyx":1
 * # ----------------------------------------------------------             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cvtools.ops.nms.soft_nms_cpu", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cvtools.ops.nms.soft_nms_cpu");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
