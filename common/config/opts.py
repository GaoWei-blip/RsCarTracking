...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--is_test', type=str, default=False,
                                 help='savepath of model.')

        # save
        self.parser.add_argument('--save_dir', type=str, default='/work/',
                                 help='savepath of model.')

        # dataset
        self.parser.add_argument('--datasetname', type=str, default='RsCarData',
                                 help='dataset name.')
        self.parser.add_argument('--data_dir', type=str, default='/work/RsCarData/',
    ...
    def parse(self, args=''):
        ...
        opt.save_dir = os.path.join(opt.save_dir, 'weights/', time_str)
        if not os.path.exists(opt.save_dir):
